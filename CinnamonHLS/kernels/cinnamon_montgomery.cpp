...
void cinnamon_montgomery(const std::uint64_t *instructions, const std::uint64_t *inputs,
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  cinnamon_hls_kernel::execute_montgomery_module(instructions, inputs, outputs,
