...
#include "kernel_arithmetic_module.hpp"

extern "C" {

void cinnamon_arithmetic(const std::uint64_t *instructions, std::uint64_t *control_words,
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  cinnamon_hls_kernel::execute_arithmetic_module(
