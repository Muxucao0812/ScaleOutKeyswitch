...
void cinnamon_arithmetic(const std::uint64_t *instructions, const std::uint64_t *inputs,
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  cinnamon_hls_kernel::execute_arithmetic_module(instructions, inputs, outputs,
