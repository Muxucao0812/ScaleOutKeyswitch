...
void cinnamon_base_conv(const std::uint64_t *instructions, const std::uint64_t *inputs,
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  cinnamon_hls_kernel::execute_base_conv_module(instructions, inputs, outputs,
