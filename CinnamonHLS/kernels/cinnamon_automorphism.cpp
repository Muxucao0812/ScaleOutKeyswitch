...
#include "kernel_automorphism_module.hpp"

extern "C" {

void cinnamon_automorphism(const std::uint64_t *instructions, const std::uint64_t *inputs,
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  cinnamon_hls_kernel::execute_automorphism_module(instructions, inputs, outputs,
                                                   instruction_count,
