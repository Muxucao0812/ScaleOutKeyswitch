...
#include "kernel_dispatch_module.hpp"

extern "C" {

void cinnamon_dispatch(const std::uint64_t *instructions, const std::uint64_t *inputs,
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  cinnamon_hls_kernel::execute_dispatch_module(
      instructions, inputs, outputs, instruction_count, input_count, output_count,
      partition_id);
}
