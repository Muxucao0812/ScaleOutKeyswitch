...
#include "kernel_transpose_module.hpp"

extern "C" {

void cinnamon_transpose(const std::uint64_t *instructions, const std::uint64_t *inputs,
...
#pragma HLS INTERFACE s_axilite port = return bundle = control
  ...
  cinnamon_hls_kernel::execute_transpose_module(instructions, inputs, outputs,
